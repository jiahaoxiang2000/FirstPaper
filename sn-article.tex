...
\begin{figure}[h]%
    \centering
    \includegraphics[width=0.8\textwidth]{struct-craft.pdf}
...
\begin{align}
    ...
    T_i & = F_{if} (BB_i[0], \thicksim (Q_{4i} \cdot Q_{4i+1}) \cdot \thicksim Q_{4i+2} \cdot Q_{4i+3}) \nonumber \\
        ...
        & \quad + F_{if} (BB_i[2], Q_{4i} \cdot Q_{4i+1} \cdot Q_{4i+2})  \label{eq1}                             \\
...
\begin{figure}[h]%   
    \centering
    \includegraphics[width=0.75\textwidth]{Mix-Columns.pdf}
...
The architecture from \cite{DBLP:conf/isvlsi/HanleyO12} operates on a round-based architecture.
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{iteration-present.pdf}
...
\begin{table}[h]
    ...
    \begin{tabular*}{\textwidth}{@{\extracolsep\fill}lcccccc}
        ...
        A3  & PRESENT       & 64           & 128            &   \cite{DBLP:conf/isvlsi/HanleyO12}           & Iterative              \\
        \bottomrule
    \end{tabular*}
\end{table}
...
\begin{equation}
    Total Power(TP) = Dynamic  Power(DP) + Static Power(SP)
    \label{eq7}
\end{equation}
\begin{equation}
...
\begin{table}[h]
    ...
    \begin{tabular*}{\textwidth}{@{\extracolsep\fill}lccccccc}
        ...
        \midrule
        \multirow{3}{*}{Artix-7}  & A1 & 64 & 128 & 144 & 177 & 59 \\
        & A2 & 64 & 128 & - & - & - \\
        & A3 & 64 & 128 & - & - & - \\
        \midrule
        \multirow{3}{*}{Spartan-7} & A1 & 64 & 128 & 144 & 177 & 57 \\
        & A2 & 64 & 128 & - & - & - \\
        & A3 & 64 & 128 & - & - & - \\
        \midrule		
        \multirow{3}{*}{Kintex-7} & A1 & 64 & 128 & 144 & 178 & 58 \\
        & A2 & 64 & 128 & - & - & - \\
        & A3 & 64 & 128 & - & - & - \\
        \bottomrule
    \end{tabular*}
...
\begin{table}[h]
    ...
    \begin{tabular*}{\textwidth}{@{\extracolsep\fill}lcccccccc}
        ...
        \midrule
        \multirow{3}{*}{Artix-7}  & A1 & 1215 & 123.76 & 6.52 & 5.27 & 110.49 \\
        & A2 & - & - & - & - & - \\
        & A3 & - & - & - & - & - \\
        \midrule			
        \multirow{3}{*}{Spartan-7} & A1 & 1215 & 123.93 & 6.53 & 5.27 & 114.53 \\
        & A2 & - & - & - & - & - \\
        & A3 & - & - & - & - & - \\
        \midrule 				
        \multirow{3}{*}{Kintex-7} & A1 & 1251 & 113.28 & 5.80 & 5.12 & 99.92 \\
        & A2 & - & - & - & - & - \\
        & A3 & - & - & - & - & - \\
        \bottomrule
    \end{tabular*}
...
\begin{table}
    ...
    \begin{tabular*}{\textwidth}{@{\extracolsep\fill}lccccccccc}
        ...
        & A3 & - & - & - & - & - \\
        \midrule 			 	
        \multirow{3}{*}{Kintex-7} & A1 & 2.00 & 145.00 & 147.00 & 1.84 & 28.73 \\
        & A2 & - & - & - & - & - \\
        & A3 & - & - & - & - & - \\
        \bottomrule
    \end{tabular*}

...
The unrolled architecture, derived from the iterative architecture delineated in \cite{beierle2019craft}, necessitates a mere 16 cycles for the completion of the encryption process. This is in stark contrast to the 32 cycles required by its iterative counterpart. It should be noted that, within this context, a single cycle is defined as encompassing two round functions of CRAFT. Despite the potential for increased area usage, this methodology yields a superior throughput at an equivalent frequency.

...
The architecture from \cite{DBLP:conf/isvlsi/HanleyO12} is based on rounds. It uses a single round function to encrypt a block, which includes a Sub-Box, a Permute, and an Add-Key operation. This round function is repeated 32 times to encrypt a single block. 
Figure~\ref{fig5} illustrates this architecture. 
Table~\ref{tab2} provides a comparison of different architectures.

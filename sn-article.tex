...
\textcolor{blue}{In the context of fault attacks, various schemes have been proposed. \cite{Kermani2019} proposed a fault diagnosis scheme, while \cite{Kaur2024} introduced an error detection scheme. Additionally, \cite{CintasCanto2022} and \cite{Canto2023} have put forward proposals for error detection in Post-Quantum Cryptography.}

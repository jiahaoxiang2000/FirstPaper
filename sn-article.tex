...
&          + F_{if} (BB_i[6], Q_{4i} + Q_{4i+1}) + F_{if} (BB_i[7], \max(a, b)) \nonumber
\end{flalign}
...
\begin{figure}[h]%   
    \centering
    \includegraphics[width=0.5\textwidth]{Mix-Columns-Times.pdf}
...
\begin{figure}[h]%   
    \centering
    \includegraphics[width=0.5\textwidth]{serial-fsm.pdf}

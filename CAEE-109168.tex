...
\begin{figure}[h]%
    \centering
    \includegraphics[width=0.9\textwidth]{./struct-craft.pdf}
...
\begin{figure*}[h]%   
    \centering
    \includegraphics[width=0.9\textwidth]{./serial-archticture.pdf}
...
\begin{figure}[h]%   
    \centering
    \includegraphics[width=0.7\textwidth]{./Mix-Columns.pdf}
    \caption{Serial Architecture of Mix-Columns with clock gating}\label{serial_mix_columns_fig}
\end{figure}

\begin{figure}[h]%   
    \centering
    \includegraphics[width=0.7\textwidth]{./Mix-Columns-Times.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{./compare-ff.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{./compare-lut.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{./compare-slices.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{./compare-maxf.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{./compare-energy.pdf}

...
1. Regarding the implementation of CRAFT under the Iterative architecture: The Iterative architecture can indeed be implemented under the CRAFT cipher as proposed by the original CRAFT paper. However, it does not provide performance data on FPGA platforms. We have added the Iterative architecture to our experiment results and compared it with the SA and UA.
